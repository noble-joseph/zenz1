...
export default function OnboardingPage() {
  ...
  return (
    <main className="min-h-screen bg-zinc-50 dark:bg-zinc-950 py-12 px-4 selection:bg-emerald-100">
      <div className="max-w-3xl mx-auto">
        <div className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-3xl p-8 shadow-xl">
          <div className="mb-10 text-center">
             <div className="inline-flex items-center gap-2 rounded-full border border-emerald-200 bg-emerald-50 px-3 py-1 text-xs font-bold text-emerald-800 mb-4">
                <Sparkles className="h-3 w-3" />
                Step 2: Define Your Creator Persona
             </div>
             <h1 className="text-3xl font-black tracking-tight mb-2 uppercase">Your Professional ID</h1>
             <p className="text-zinc-500 dark:text-zinc-400">This is how you will be discovered by hirers and fellow creators.</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <div className="flex flex-col items-center gap-4">
               <div className="relative group">
                  <div className="h-32 w-32 rounded-full border-4 border-white dark:border-zinc-800 bg-zinc-100 dark:bg-zinc-800 overflow-hidden shadow-inner">
                     {avatarPreview ? (
               ...
               <p className="text-xs font-bold uppercase tracking-widest text-zinc-400">Profile Photo</p>
            </div>
            ...
            <div className="grid gap-6 md:grid-cols-2">
               ...
               <div className="space-y-2">
                  <label className="text-xs font-black uppercase tracking-widest text-zinc-500">Public ID (Slug)</label>
                  <Input 
            ...
            <div className="space-y-4">
               <label className="text-xs font-black uppercase tracking-widest text-zinc-500">I am a professional...</label>
               <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-3">
                  {PROFESSIONS.map((prof) => (
                    ...
                    >
                       <prof.icon className="h-6 w-6 mb-2" />
                       <span className="text-[10px] font-black uppercase tracking-tight">{prof.label}</span>
                    </button>
                  ))}
               </div>
            </div>
            ...
            <div className="space-y-2">
               <label className="text-xs font-black uppercase tracking-widest text-zinc-500">Specializations (Comma separated)</label>
               <Input 
                 placeholder="4K Color Grading, Sound Design, Live Streaming" 
                 className="rounded-xl h-12"
            ...
            <div className="space-y-2">
               <label className="text-xs font-black uppercase tracking-widest text-zinc-500">Achievements (One per line)</label>
               <Textarea 
            ...
            <Button 
              type="submit" 
              disabled={loading}
              className="w-full rounded-2xl h-14 bg-emerald-600 hover:bg-emerald-700 text-white font-black text-lg uppercase tracking-widest"
            >
